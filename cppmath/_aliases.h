...
namespace math::alias {
	...
	template <Dimension Dim> using    ColVectorI =    ColVector<int, 1, Dim>;
	template <Dimension Dim> using    RowVectorI =    RowVector<int, Dim, 1>;
	...
	template <Dimension Dim> using    ColVectorU =    ColVector<unsigned int, 1, Dim>;
	template <Dimension Dim> using    RowVectorU =    RowVector<unsigned int, Dim, 1>;
	...
	template <Dimension Dim> using    ColVectorD =    ColVector<double, 1, Dim>;
	template <Dimension Dim> using    RowVectorD =    RowVector<double, Dim, 1>;
	...
	template <Dimension Dim> using    ColVectorF =    ColVector<float, 1, Dim>;
	template <Dimension Dim> using    RowVectorF =    RowVector<float, Dim, 1>;
